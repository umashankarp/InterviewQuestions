...
10. **As a Principal Engineer establishing organization-wide Docker image-security standards, design the complete governance program (synthesizing this module) required before any custom-built image is permitted in a shared, multi-team registry.**
