...
## 6. Anti-patterns
- Applying a greedy algorithm to a problem by analogy to a different problem where greedy happens to work, without independently proving the greedy-choice property for this specific problem's actual structure (the incident, the coin-change trap).
